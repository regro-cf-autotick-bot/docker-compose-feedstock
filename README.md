About docker-compose-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/docker-compose-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/docker-compose-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `docker-compose` available on your platform:
...
```
pixi search docker-compose --channel conda-forge
```
